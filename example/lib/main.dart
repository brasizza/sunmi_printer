                ...
                children: [
                  ...
                  Wrap(
                    children: [
                      OutlinedButton(
                        onPressed: () async {
                          await printerController.printQrcode(text: "I love flutter", style: null);
                        },
                        child: Text("Qrcode"),
                      ),
                      OutlinedButton(
                        onPressed: () async {
                          await printerController.printText(text: "I love flutter", style: null);
                        },
                        child: Text("Print text (No style)"),
                      ),
                    ],
                  )
                ],
